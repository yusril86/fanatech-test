...
<div id="home">
    ...
    <div class="container-fluid mt-5">                                
        <div class="d-flex justify-content-end ">    
            ...
            @else
            <a href="{{ route('purchases.purchase.create') }}" class="btn btn-primary btn-sm shadow-sm ">
                <i class="fas fa-plus"></i>
                <span>Tambah Data</span>
            </a> 
            @endrole        
        ...
        <div class="card card-rounded">
            ...
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> 
                                    ...
                                    <form action="{{ route('admin.purchase.destroy', $purchase->id) }}" method="POST"
                                        class="d-inline" >
                                        @csrf
                                        @method('delete')
                                        <input name="_method" type="hidden" value="DELETE">
                                        <button class="btn btn-danger delete-confirm" data-name="{{ $purchase->name }}">
                                    ...
                                    @role('Purchase')                                   
                                    <a href="{{ route('purchases.purchase.edit', $purchase->id) }}" class="btn btn-info">
                                        <i class="fa fa-pencil-alt"></i>
                                    </a>
                                    <form action="{{ route('purchases.purchase.destroy', $purchase->id) }}" method="POST"
                                        class="d-inline" >
                                        @csrf
                                        @method('delete')
                                        <input name="_method" type="hidden" value="DELETE">
                ...
                <div class="d-flex justify-content-center mt-2">
                    <h4>Data Pembelian belum ada</h3>
                </div>
                @endif
            </div>
        </div>
