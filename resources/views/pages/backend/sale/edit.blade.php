        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @else
                    <form method="POST" action="{{route("sales.sales.update",$sale->id)}}">
                    @endrole
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group is-invalid">
                                        <input type="text" class="mt-1 form-control @error('number') border-danger @enderror"
                                            name="number" id="number" placeholder="" value="{{$sale->number}}" required>
                                        @error('number')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group is-invalid">
                                        <input type="date" class="mt-1 form-control @error('date') border-danger @enderror"
                                            name="date" id="date" placeholder="" value="{{ date("$sale->date", strtotime($sale->date)); }}" required>
                                        @error('date')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
